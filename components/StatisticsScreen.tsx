          ...
          {!GAS_URL ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-slate-800/50 p-6 rounded-2xl border border-white/5">
                <h3 className="text-lg font-bold text-white mb-4">Sikerességi ráta kategóriánként</h3>
                <div className="space-y-4">
                  {Object.entries(globalData.categorySuccess).map(([cat, rate]) => (
                    <div key={cat}>
                      ...
                      <div className="h-2 bg-slate-900 rounded-full overflow-hidden">
                        <div className="h-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.5)]" style={{ width: `${rate}%` }}></div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-slate-800/50 p-6 rounded-2xl border border-white/5">
                ...
                <div className="space-y-3">
                  {globalData.difficultQuestions.map((q, i) => (
                    <div key={i} className="p-3 bg-red-500/5 rounded-lg border border-red-500/10">
                      <div className="text-[10px] text-red-400 font-bold uppercase mb-1">Rontási arány: {q.failRate}%</div>
